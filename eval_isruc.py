...
def run_finetune(base_model, X_tr_np, y_tr_np, X_val_np, y_val_np,
    ...
    # CBraMod Table 6 FT: gentle LR 1e-4 cosine → 1e-6, wd 5e-2, label
    # smoothing 0.1. Far more stable on the small sleep val set than the old
    # onecycle 4e-3 (which collapsed val to chance at high-LR epochs).
